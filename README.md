...
```bash
$ npm install --save @mrk13n/react-native-multi-slider
```
...
| pressedMarkerStyle |  | style object | Styles for the slider |
...
| separatorStyle |  | style object | Styles for the separator
| stepTextStyle |  | style object | Styles for the step text
